                    ...
                    <form class="row g-3" action="javascript:void(0)" method="post" id="save_sale"
                        ...
                        <div class="row mt-4">
                          ...
                          ?>
                                    ...
                                    <div class="col-md-4">
                                        <label for="Customer Remarks" class="form-label customer_remarks_col"
                                            style="display:none;">Customer Remarks</label>
                                        <p id="customer_remarks"></p>
                                    </div>
                                    <div class="col-md-2">
                                        <label for="Customer Payment Type" class="form-label customer_payment_type_col"
                                            style="display:none;">Payment Type</label>
                                        <p id="customer_category"></p>
                                    </div>
