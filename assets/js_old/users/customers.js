...
$('#create_customer').click(function () {
    ...
    $('.modal_select_cat_type_,.modal_select_salesperson_,.modal_select_assign_driver_,.modal_select_day_').select2({

      dropdownParent: $('.create_customer_modal')
...
function editCustomer(id)
{
    ...
    $.ajax({
      ...
      success :function (response) {
        ...
        $('.modal_edit_cat_type_,.modal_edit_salesperson_,.modal_edit_assign_driver_,.modal_edit_day_').select2({

          dropdownParent: $('.edit_customer_modal_')
